...
export const PERMISSIONS: IPermissions = {
  ...
  create_news_competition: 'Конкурсы',
  ...
  sort_news_competition: 'Конкурсы',
  sort_course: 'Курсы',
  ...
  edit_news_competition: 'Конкурсы',
  edit_course: 'Курсы',
  ...
  soft_delete_news_competition: 'Конкурсы',
  ...
  force_delete_news_competition: 'Конкурсы',
  ...
  restore_news_competition: 'Конкурсы',
